    ...
    <div className={styles.profile__feeds}>
      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <Input id="industry" placeholder="I am an Musician and Hip-hop Artist & Songwriter" />
          </div>
          <div>
          ...
          <div>
            ...
            <Input id="website" placeholder="https://soundcloud.com/username" />
          </div>
        </div>
      </section>
      ...
      <section className="space-y-4">
        ...
        <div className="space-y-2">
          <Label>Why are you on ProCollabs? Select all that apply. I am:</Label>
          {[
      ...
      <section className="space-y-4">
        ...
        <Textarea placeholder="Musician, Songwriter, Composer, Lyricist" className="min-h-[100px]" />
        <p className="text-sm text-gray-500">Max. 10,000 characters</p>
      </section>

      <section className="space-y-4">
        <h2 className="text-xl font-semibold">My Gear, Equipment, Setup...</h2>
        <Textarea placeholder="Tell us about your gear..." className="min-h-[100px]" />
      ...
      <section className="space-y-4">
        ...
        <div className="flex flex-col md:flex-row gap-2">
          ...
          <Input placeholder="https://youtube.com/user" className="flex-grow" />
          <Button>Add</Button>
        </div>
      </section>
      ...
      <section className="space-y-4">
        ...
        <p className="text-red-500">DO NOT put your house or apartment address. Others can see this information.</p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
      ...
      <section className="space-y-4">
        ...
        <p className="text-sm text-gray-600">
          If you would like to include direct contact information on your profile, such as a telephone number or email for your business then you can include it here. NOTE that this information will be visible publicly and can be indexed by search engines. It is NOT RECOMMENDED to share any personal information.
        </p>
        <Textarea placeholder="Enter your contact information" className="min-h-[100px]" />
        <Button>Save Changes</Button>
      </section>

      <section className="space-y-4">
        <h2 className="text-xl font-semibold">Performance Rights Organization (PRO) Affiliation</h2>
        <p className="text-sm text-gray-600">
          If you are affiliated with a PRO, enter your CAE/IPI number here. Your details will be automatically entered on songwriter split sheets and shared with co-writers. Optionally, you can also display this information on your personal profile.
        </p>
        <div className="flex flex-col md:flex-row gap-2">
          <Select>
            <SelectTrigger>
      ...
      <section className="space-y-4">
        <h2 className="text-xl font-semibold">Shared Collaboration Information</h2>
        <p className="text-sm text-gray-600">
          Rather than your username, your Artist Name will be used whenever you close a project and accept copyright ownership or credit in a completed song.
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
          ...
          <div>
            ...
            <Input id="shared-contact" placeholder="Shared contact information" />
          </div>
        </div>
        <Button>Save Changes</Button>
      </section>
      ...
      <section className="space-y-4">
        ...
        <p className="text-sm text-gray-600">
          Members can activate the Tip Jar feature on their profile page by adding a valid PayPal email or Merchant ID here.
        </p>
        <Input placeholder="PayPal email or Merchant ID" />
        <div className="flex items-center space-x-2">
          <Info className="text-blue-500" />
          <p className="text-sm text-gray-600">
            Please be aware that if using your PayPal email, the email address will be visible to others. PayPal Business accounts can use their Merchant ID instead. However, make sure that your PayPal account is configured to accept this method.
          </p>
        </div>
        <Button>Save Changes</Button>
      </section>
      ...
      <section className="space-y-4">
        <h2 className="text-xl font-semibold">Privacy and Security Settings</h2>
        <div className="space-y-2">
          {[
