...
export default function CollaborationAgreement() {
  ...
  const agreements = [
    ...
    },
    {
      ...
      subtitle: "",
      content: "You have chosen to customize your collaboration agreement. Please provide your custom agreement details."
    }
  ]
  ...
  return (
    <div className="space-y-4">
      <Select
        ...
        onValueChange={(value) => setSelectedAgreement(value)}
      >
        ...
        <Card className="bg-gray-50">
          <CardContent className="p-4 text-sm">
            <h3 className="text-lg font-semibold mb-2">
              {agreements.find(a => a.value === selectedAgreement)?.title}
            </h3>
            {agreements.find(a => a.value === selectedAgreement)?.subtitle && (
              <p className="mb-2">{agreements.find(a => a.value === selectedAgreement)?.subtitle}</p>
            )}
            <p>{agreements.find(a => a.value === selectedAgreement)?.content}</p>
          </CardContent>
        </Card>
      )}
    </div>
