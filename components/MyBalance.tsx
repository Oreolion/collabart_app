...
export default function MyBalance() {
  return (
    <div className="container mx-auto p-4 max-md:pl-[1px]">
      <Card className="bg-slate-600">
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            <div className="text-center max-md:max-w-[25rem]">
              <h3 className="text-lg font-semibold mb-2">in Credit</h3>
              <p className="text-3xl font-bold">$0.00</p>
            </div>
            <div className="text-center bg-green-100 p-4 rounded-lg max-md:max-w-[25rem]">
          ...
          <div className="space-y-4">
            <Button className="w-full justify-start max-md:max-w-[25rem]" variant="outline">
